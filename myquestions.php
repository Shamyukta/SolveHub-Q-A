...
<body>
    ...
    <nav class="navbar navbar-default">
     ...
     <ul class="nav navbar-nav">
       ...
       <li class="active"><a href="#" style="background-color: red; color: black;">My Questions</a></li>
 ...
 <div class="bodyContainer">
   <div style="border-bottom: 1px solid white;"><p class="title">My Questions</p></div>
   <div id="myques"></div>
 <?php } ?>
